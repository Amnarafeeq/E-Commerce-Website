...
const TodayDeals = () => {
  return (
    <main>
      ...
      <section className="flex justify-between mt-8 flex-wrap max-sm:py-5 max-sm:gap-y-20">
        {/* div 1 */}
        <div className="w-56 h-80 max-sm:w-40 max-sm:h-64 flex flex-col gap-4 items-center  justify-center ">
          ...
          <p className="ml-3 px-2">
            ZEBRONICS Zeb-Reaper 2.4GHz Wireless Gaming Mouse
          </p>
          <div className="flex gap-x-16 text-sm max-sm:gap-x-10 ">
            <p>₹1,599.00</p>
        ...
        <div className="w-56 h-80 max-sm:w-40 max-sm:h-64 flex flex-col gap-4 items-center  justify-center ">
          ...
          <p className="ml-3 px-1">
            Zebronics Zeb-Transformer-k USB Gaming Keyboard | RGB LED lighting
          </p>
          <div className="flex gap-x-20 text-sm max-sm:gap-x-10">
            <p>₹999.00</p>
        ...
        <div className="w-56 h-80 max-sm:w-40 max-sm:h-64 flex flex-col gap-4 items-center  justify-center ">
          ...
          <p className="ml-4 px-1 ">
            Scarters Mouse Pad, Deskmat Extended for Work from
            Home/Office/Gaming
          </p>
          <div className="flex gap-x-12 text-sm max-sm:gap-x-10">
            <p>₹1,599.00</p>
        ...
        <div className="w-56 h-80 max-sm:w-40 max-sm:h-64 flex flex-col gap-4 items-center  justify-center ">
          ...
          <p className="ml-5 px-4 max-sm:ml-2 max-sm:px-2">
